...
For coders:
Something that could be added is X-Dividers also changing height and make them go into the extra box and possibly a function to cut the box and lid in half to accomodate smaller Printers so cutting doesn´t need to be done on the printer Software.